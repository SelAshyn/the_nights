...
export default function EnhancedQuizPage() {
  ...
  const CardButton = ({ label, selected, onClick, className }: { label: string; selected: boolean; onClick: () => void; className?: string }) => (
    <button
      onClick={onClick}
      className={`w-full px-4 py-3.5 rounded-lg border transition-all duration-150 text-sm font-medium text-left ${selected ? 'border-slate-900 bg-slate-900 text-white' : 'border-slate-200 hover:bg-slate-300/30 text-slate-700'
        } ${className || ''}`}
    >
      {label}
    </button>
  ...
  // ---- MAIN SCREEN RENDER ----
  return (
    <div className={`${inter.className} flex min-h-screen items-center justify-center bg-white relative p-4`}>
      {/* Welcome Screen */}
      {step === 0 && (
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-6xl md:text-7xl font-light animate-fade">Welcome to MentorLaunch</h1>
        </div>
      )}

      {/* Step 1 – Academic Level */}
      {step === 1 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          <Section
          ...
          <button
            className={`mt-6 w-full py-3.5 rounded-lg font-semibold text-sm ${selectedGrade ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400 cursor-not-allowed'
              }`}
      ...
      {step === 2 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${selectedCareer ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400 cursor-not-allowed'
                }`}
      ...
      {step === 3 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${favSubjects.length ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 4 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${bestSubjects.length ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 5 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${workEnvironment ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 6 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${taskPreference ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 7 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${skills.length ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 8 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${techConfidence ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 9 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${workLife ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
              disabled={!workLife}
              onClick={goNext}
            >Continue</button>
          </div>
      ...
      {step === 10 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${careerMotivation ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
      ...
      {step === 11 && (
        <div className="max-w-md w-full p-8 bg-white rounded-2xl shadow-xl border border-slate-200 animate-slide-up">
          ...
          <div className="flex gap-3 mt-6">
            <button className="w-1/3 py-3 rounded-lg bg-slate-100" onClick={goBack}>Back</button>
            <button
              className={`w-2/3 py-3 rounded-lg font-semibold text-sm ${studyGoal ? 'bg-slate-900 text-white' : 'bg-slate-100 text-slate-400'}`}
              disabled={!studyGoal}
