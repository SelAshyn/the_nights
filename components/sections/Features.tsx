...
export const Features = () => {
  ...
  return (
    <div id="features" className="py-24 sm:py-32 scroll-mt-20 bg-gradient-to-r from-gray-900 via-slate-900 to-teal-900">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2
            className="text-base font-semibold leading-7 text-teal-400 font-display"
            data-aos="fade-down"
          >
            Powerful Features
          </h2>
          <p
            className="mt-2 text-4xl font-heading font-bold tracking-tight text-white sm:text-5xl"
            data-aos="fade-up"
            data-aos-delay="100"
          >
          ...
          <p
            className="mt-6 text-lg leading-8 text-slate-300 font-body"
            data-aos="fade-up"
            data-aos-delay="200"
          >
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
            {features.map((feature, index) => (
              ...
              >
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-white font-heading">
                  <div className="rounded-lg bg-gradient-to-br from-teal-500 to-cyan-600 p-2">
                    <feature.icon className="h-5 w-5 text-white" aria-hidden="true" />
                  </div>
                  {feature.name}
                </dt>
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-slate-300 font-body">
