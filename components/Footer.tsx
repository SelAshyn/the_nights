      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <img src="/logo.svg" width="28" height="28" alt="MentorLaunch" />
            <div className="text-sm">
              <span className="font-semibold text-slate-900">MentorLaunch</span>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex gap-3">
              ...
              <a href="#" className="text-slate-400 hover:text-indigo-600 transition-colors" aria-label="GitHub">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
